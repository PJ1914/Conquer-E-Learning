          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                ...
                <path fill="#34A853" d="M10.9 24v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796V24"/>
                <path fill="#FBBC05" d="M6.848 24v-8.385H4.126v-3.47h2.722V9.43c0-3.007 1.5-4.669 3.8-4.669 1.1 0 2.25.2 2.25.2v2.953H11.4c-1.25 0-1.64.78-1.64 1.58v2.25h2.78l-.45 3.47H9.76V24"/>
                <path fill="#EA4335" d="M12 5.25c1.58 0 3 .58 4.12 1.53l3.08-3.08C17.42 1.83 14.92.75 12 .75 7.34.75 3.32 3.47 1.5 7.33l3.5 2.72C6.2 7.33 8.88 5.25 12 5.25z"/>
              </svg>
